        ...
        body::before {
            ...
            background:
                radial-gradient(ellipse 60% 40% at 20% 10%,
                    ...
                    transparent 70%),
                radial-gradient(ellipse 50% 50% at 80% 90%,
                    rgba(251, 146, 60, 0.08) 0%,
                    transparent 60%),
                radial-gradient(ellipse 40% 40% at 60% 40%,
...
<body class="relative z-10 flex flex-col items-center py-6 px-3 min-h-screen">
    ...
    <div style="
      ...
      "
        ...
        <div class="stat-pill">
            ...
            <div class="val" id="pairs-val">0/10</div>
        </div>
    ...
    <!-- PROGRESS -->
    <div style="width: 100%; max-width: 480px; margin-bottom: 14px" class="relative z-10">
    ...
    <!-- GRID -->
    <div id="grid" style="width: 100%; max-width: 480px; margin-bottom: 16px" class="relative z-10"></div>

    <!-- ACTION BUTTONS -->
    <div style="display: flex; gap: 12px; flex-wrap: wrap; justify-content: center" class="relative z-10">
            ...
            <div class="result-body">
                <div class="res-grid">
                    ...
                    <div class="res-stat">
                        ...
                        <div class="rs-unit">out of 10</div>
                    </div>
                    <div class="res-stat">
                ...
                <div class="res-actions">
                    <button class="btn btn-orange" style="flex: 1"
                        onclick="
                playSound('click');
                closeResult();
                initGame();
    ...
    <script>
        ...
        function initGame() {
            ...
            document.getElementById("pairs-val").textContent = "0/10";
            ...
            nums.forEach((n) => {
                ...
                c.dataset.val = n;
                c.innerHTML =
                    `<div class="card-inner"><div class="card-face card-back"><div class="q-mark">?</div></div><div class="card-face card-front"><span class="num">${n}</span></div></div>`;
            ...
            if (flipped.length === 2) {
                ...
                if (a.dataset.val === b.dataset.val) {
                    setTimeout(() => {
                        ...
                        matched++;
                        const pct = Math.round((matched / 10) * 100);
                        ...
                        flipped = [];
                        lock = false;
                        if (matched === 10) setTimeout(showWin, 400);
                    }, 250);
                } else {
                    setTimeout(() => {
                        playSound("wrong");
        ...
        function getRating() {
            ...
            if (done) {
                ...
                if (matched >= 7) {
                    ...
                    emoji = "🔥";
                    title = "Almost There!";
                    sub = matched + "/10 pairs found so far";
                } else if (matched >= 4) {
                    stars = 2;
                    emoji = "💪";
                    title = "Getting Warmer!";
                    sub = matched + "/10 pairs matched";
                } else {
                    stars = 1;
                    emoji = "🌱";
                    title = "Just Started!";
