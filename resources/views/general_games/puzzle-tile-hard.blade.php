...
<body class="animated-bg min-h-screen">
    ...
    <main class="max-w-2xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-8 md:py-12">
        ...
        <div class="board-shell rounded-xl sm:rounded-2xl md:rounded-3xl p-3 sm:p-4 md:p-6 mb-3 sm:mb-4 md:mb-6">
            <div id="puzzle-grid" class="grid grid-cols-5 gap-1.5 sm:gap-2 md:gap-3">
            ...
            <div
              ...
              ">
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <div id="number-list" class="grid grid-cols-5 gap-1.5 sm:gap-2">
                        <!-- Numbers will be generated here in 5x5 grid -->
                    </div>
                </div>
                ...
                for (let i = 0; i < this.size; i++) {
                    for (let j = 0; j < this.size; j++) {
                        ...
                        if (this.grid[i][j] === 0) {
                            ...
                            tile.innerHTML =
                                `<span class="orbitron text-lg sm:text-xl md:text-2xl lg:text-3xl font-black text-white" style="text-shadow: 0 0 14px rgba(0,255,209,0.20);">${this.grid[i][j]}</span>`;
