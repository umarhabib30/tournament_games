...
<html lang="en">
  <head>
    ...
    <title>jigsaw puzzle medium</title>
  ...
  <body>
    ...
    <div id="result-modal">
      <div class="modal-card">
        <div style="font-size: 3rem; margin-bottom: 12px">Puzzle Done</div>
        <h2
          id="result-title"
          style="
            font-family: 'Orbitron', monospace;
    ...
    <script>
      ...
      function showResult(isManualSubmit = false) {
        ...
        const stars = correctCount === TOTAL_TILES ? 3 : correctCount >= 10 ? 2 : 1;
