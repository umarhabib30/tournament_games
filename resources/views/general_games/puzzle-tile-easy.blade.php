...
<head>
    ...
    <style>
        * {
        ...
        .animated-bg {
            background:
                radial-gradient(900px 500px at 20% 12%,
                    rgba(20, 164, 255, 0.18),
                    transparent 60%),
                radial-gradient(700px 420px at 80% 30%,
                    rgba(0, 255, 209, 0.14),
                    transparent 55%),
                radial-gradient(900px 520px at 60% 90%,
...
<body class="animated-bg min-h-screen">
    ...
    <main class="max-w-2xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-8 md:py-12">
        ...
        <div class="text-center mb-4 sm:mb-6 md:mb-8">
            ...
            <p class="text-white/75 text-xs sm:text-sm md:text-base lg:text-lg px-2 sm:px-4">
                " Arrange numbers in order with empty box at bottom right."
            </p>
        </div>
        ...
        <div class="flex gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-8">
            <div class="stats-box flex-1 rounded-xl sm:rounded-2xl px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4">
                ...
                <div class="text-white text-xl sm:text-2xl md:text-3xl font-bold orbitron" id="moves">
                    0
                </div>
            </div>
            ...
            <div class="stats-box flex-1 rounded-xl sm:rounded-2xl px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4">
                ...
                <div class="text-white text-xl sm:text-2xl md:text-3xl font-bold orbitron" id="timer">
                    00:00
                </div>
            </div>
        </div>
        ...
        <div class="board-shell rounded-xl sm:rounded-2xl md:rounded-3xl p-3 sm:p-4 md:p-6 mb-3 sm:mb-4 md:mb-6">
            <div id="puzzle-grid" class="grid grid-cols-3 gap-1.5 sm:gap-2 md:gap-3">
        ...
        <div class="min-h-screen flex items-center justify-center p-3 sm:p-4">
            <div
              ...
              ">
                        ...
                        <div class="text-white text-lg sm:text-xl md:text-2xl font-bold orbitron" id="final-time">
                            00:00
                        </div>
                    </div>
              ...
              ">
                        ...
                        <div class="text-white text-lg sm:text-xl md:text-2xl font-bold orbitron" id="final-moves">
                            0
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <div id="number-list" class="grid grid-cols-3 gap-1.5 sm:gap-2">
                        <!-- Numbers will be generated here in 3x3 grid -->
                    </div>
                </div>
    ...
    <script>
        ...
        class PuzzleGame {
            constructor() {
                // ===== 3x3 CONFIG (ONLY LOGIC/GRID SIZE CHANGED) =====
                this.size = 3; // 3x3
                this.totalTiles = this.size * this.size; // 9
                this.maxNumber = this.totalTiles - 1; // 8
                // ====================================================
            ...
            initializeGrid() {
                // Initialize grid with numbers 1-8 and one empty space (3x3)
                let num = 1;
            ...
            shuffleGrid() {
                ...
                // For odd-width (3x3), solvable iff inversions is even
            ...
            isSolvable(tiles) {
                ...
                // 3x3 (odd grid width): solvable iff inversions even
            ...
            getCurrentTilePositions() {
                ...
                for (let i = 0; i < this.size; i++) {
                    for (let j = 0; j < this.size; j++) {
                        if (this.grid[i][j] !== 0) positions.push(this.grid[i][j]);
                    }
                }
                return positions;
            }
