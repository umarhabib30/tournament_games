  ...
  <body class="text-gray-100">
    ...
    >
      ...
      <div class="flex justify-center gap-4 mb-6">
        ...
        <button
          id="submit-btn"
          class="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          disabled
        >
    ...
    <div id="results-modal" class="modal-overlay hidden">
      <div class="modal-content success-popup">
        <div class="text-center">
          ...
          <h2 id="result-title" class="text-2xl font-bold text-white mb-2">
            Game Progress
          </h2>
          <p id="result-message" class="text-gray-300 mb-4">
          ...
          <div class="bg-gray-800 rounded-lg p-4 mb-4">
            <div class="flex justify-between items-center mb-2">
              ...
              <span id="result-numbers" class="text-xl font-bold text-blue-400"
                >0/25</span
              >
            </div>
            <div class="flex justify-between items-center mb-2">
              <span class="text-gray-400">Your Time:</span>
              <span id="final-time" class="text-xl font-bold text-green-400"
                >00:00</span
              >
            </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        endGame = function (isComplete = false) {
          if (isComplete) {
            continueBtn.classList.add("hidden");
          } else {
            continueBtn.classList.remove("hidden");
          }
          originalEndGame.call(this, isComplete);
        };
