...
<section class="relative px-6 py-24 text-center overflow-hidden">
  ...
  <div class="relative z-10 max-w-4xl mx-auto">
    ...
    <p
      class="text-lg sm:text-xl md:text-2xl text-white/90 mb-12 leading-relaxed max-w-3xl mx-auto animate-fade-in"
    >
...
@keyframes pulseSlow {
  0%, 100% { opacity: 0.5; transform: scale(0.3); }
...
.animate-fade-in { animation: fadeIn 1.3s ease-out 0.2s forwards; }
.animate-pulse-slow { animation: pulseSlow 5s infinite ease-in-out; }
.animate-bounce-smooth { animation: bounceSmooth 3s infinite ease-in-out; }
</style>
...
<section class="relative px-6 py-24 bg-black/30 backdrop-blur-md overflow-hidden">
  ...
  <div class="max-w-6xl mx-auto text-center">
    <h3
      class="text-4xl md:text-6xl font-black text-white mb-16 leading-tight"
      style="font-family: 'Orbitron', sans-serif;"
    >
      JOIN THE <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">NEXT-GEN</span> GAMING ERA
    </h3>
...
<footer class="relative bg-black/30 backdrop-blur-sm border-t border-white/10 px-6 py-20 text-center overflow-hidden">
  <div class="max-w-6xl mx-auto">
    ...
    <h3
      ...
      style="font-family: 'Orbitron', sans-serif;"
    >
      POWER UP   <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500"> YOUR MIND,</span> ONE GAME AT A TIME
    </h3>
    ...
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute -top-10 left-1/2 -translate-x-1/2 w-96 h-96 bg-cyan-500/10 blur-3xl rounded-full"></div>
