...
<head>
    ...
    <style>
        * {
        ...
        .glow-text {
            text-shadow: 0 0 18px rgba(0, 255, 209, 0.35), 0 0 36px rgba(20, 164, 255, 0.22);
        }
        ...
        @keyframes pulseGlow {
            ...
            0%,
            100% {
                box-shadow: 0 0 0 1px rgba(0, 255, 209, 0.18), 0 0 22px rgba(0, 255, 209, 0.22);
            }
        ...
        <div class="min-h-screen flex items-center justify-center p-3 sm:p-4">
            <div
              ...
              backdrop-filter: blur(10px);">
                        ...
                        <div class="text-white text-lg sm:text-xl md:text-2xl font-bold orbitron" id="final-time">00:00
                        </div>
                    </div>
              ...
              backdrop-filter: blur(10px);">
                        ...
                        <div class="text-white text-lg sm:text-xl md:text-2xl font-bold orbitron" id="final-correct">0
                        </div>
                    </div>
                </div>
