...
<head>
    ...
    <!-- jQuery (same as your first game) -->
...
<body
    ...
    <!-- Laravel submit form (same approach as your first game) -->
        ...
        <div class="modal-show w-full max-w-lg rounded-3xl bg-slate-900 border border-slate-700 shadow-2xl">
            <div class="p-6 md:p-8">
                <div class="flex items-start justify-between gap-4">
                    ...
                    {{-- <button id="closeModal" class="p-2 rounded-xl bg-slate-800 hover:bg-slate-700" type="button">
                        ✕
                    </button> --}}
                </div>
    ...
    <script>
        ...
        // ✅ Server-synced timing (same concept as your first game)
        const serverNow = {{ $serverNow }} * 1000;
        const endTime = {{ $endtime }} * 1000;

        // Drift correction between client and server at page load
        ...
        // ✅ Server-synced remaining time countdown with drift correction (like your first game)
        ...
        function startGame() {
            ...
            startTime = Date.now(); // for time_taken
            updateCountdownTimer(); // for time remaining
        ...
        // ✅ score = correct - wrong, submit score & time_taken like first game
        function submit(force = false) {
            ...
            // finalScore = Math.max(0, finalScore); // uncomment if you want no negative scores
            ...
            // same AJAX method as your first game
            $.ajax({
