                            ...
                            <tbody>
                                @foreach ($tournaments as $index => $tournament)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.tournament.details', $tournament->id) }}" class="btn btn-sm btn-info">View</a>
                                            <a href="{{ route('admin.tournament.results', $tournament->id) }}" class="btn btn-sm btn-info">Results</a>
                                            <a href="{{ route('admin.tournament.edit', $tournament->id) }}" class="btn btn-sm btn-primary">Edit</a>
